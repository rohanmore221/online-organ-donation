...
<a class="active" href="docreg.php">DOCTOR</a>
</div>
    ...
    <div class="login-form">
        ...
        <form class="login-form" method="POST" action="docreg.php">
            <?php include('errors.php');
            ?>
            <input type="text" placeholder="Username" name="username" />
                <input type="text" placeholder="license ID" name="licenseid" />
                <input type="tel" placeholder="Aadhar-no" name="adharno" />
                <input type="text" placeholder="Mobile-no" name="contactno" />
                <input type="text" placeholder="Organ transplant you specialized" name="organ" />
